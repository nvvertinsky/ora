-- Порядок действий
-- 1. Найти блокирующую и посмотреть сколько она блокирует строк
-- 2. Посмотреть какие объекты она блокирует 
...
-- 5. Нужно позвонить пользователи и спросить что он сейчас делает. Только так можно узнать точно причину.
-- 6. Убить сессию.
